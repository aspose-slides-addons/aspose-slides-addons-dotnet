...
namespace Aspose.Slides.Addons.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "24.4.0";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/24.4.0/csharp");
            BasePath = "https://api.aspose.dev/v1.0/slides";
        ...
        public Configuration(
            ...
            string basePath = "https://api.aspose.dev/v1.0/slides") : this()
        {
        ...
        {
            string report = "C# SDK (Aspose.Slides.Addons.Sdk) Debug Report:\n";
